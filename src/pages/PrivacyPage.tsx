      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        <div className="flex items-center gap-3 mb-8">
          ...
          <div>
            ...
            <p className="text-gray-400 text-sm mt-1">Последнее обновление: 16 июня 2026 г.</p>
          </div>
        </div>
        ...
        <div className="prose prose-invert max-w-none space-y-8">
          ...
          <section className="bg-gray-900 rounded-2xl border border-white/5 p-6">
            ...
            <ul className="space-y-2 text-sm text-gray-300">
              {[
                'Email и пароль — классическая регистрация и вход с подтверждением электронной почты',
              ].map((item) => (
                <li key={item} className="flex items-start gap-2">
                  <span className="text-emerald-400 mt-0.5">•</span>
                  {item}
            ...
            <p className="text-gray-400 text-sm mt-3">
              Платформа не использует авторизацию через иностранные корпоративные сервисы (Google, Apple ID и др.)
              для обеспечения безопасности и стабильности доступа пользователей в соответствии с требованиями
          ...
          <section className="bg-gray-900 rounded-2xl border border-white/5 p-6">
            ...
            <ul className="space-y-2 text-sm text-gray-300">
              {[
                ...
                'Отправка сервисных, системных и информационных сообщений от администрации Платформы',
              ].map((item) => (
                <li key={item} className="flex items-start gap-2">
                  <span className="text-emerald-400 mt-0.5">•</span>
                  {item}
          ...
          <section className="bg-gray-900 rounded-2xl border border-white/5 p-6">
            ...
            <p className="text-gray-300 leading-relaxed text-sm">
              Данные пользователей хранятся на изолированных защищенных облачных серверах с использованием
              современных стандартов шифрования и контроля доступа. Технические данные сессий хранятся в
              localStorage браузера пользователя и автоматически удаляются при выходе из аккаунта или очистке кэша.
            </p>
          </section>
